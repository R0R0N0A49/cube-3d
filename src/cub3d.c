...
void	cub3d(t_map *data)
{
	...
	data->texedi = mlx_load_png ("./tiles/menu/edit.png");
	data->texexit = mlx_load_png ("./tiles/menu/exit.png");
	data->nuit = mlx_load_png("./tiles/textures/nuit.png");
	...
	data->opt->unvalid_txt = mlx_load_png("./tiles/menu/checkB.png");
	data->opt->valid_txt = mlx_load_png("./tiles/menu/checkG.png");
	...
	data->opt->rtn_txt = mlx_load_png("./tiles/menu/return.png");
	data->opt->rtn = mlx_texture_to_image(data->mlx, data->opt->rtn_txt);
	data->opt->music_txt = mlx_load_png("./tiles/menu/music.png");
	data->opt->music = mlx_texture_to_image(data->mlx, data->opt->music_txt);
	data->opt->fps_txt = mlx_load_png("./tiles/menu/FPS.png");
	data->opt->roof_txt = mlx_load_png("./tiles/menu/roof.png");
	data->opt->mini_txt = mlx_load_png("./tiles/menu/mini.png");
	...
	data->opt->but_map = &fov;
	data->opt->but_fps = &floor;
	data->opt->but_night = &roof;
	...
	mlx_image_to_window(data->mlx, data->opt->fps, data->opt->but_fps->but_x_min + 4, data->opt->but_fps->but_y_min + 10);
	mlx_image_to_window(data->mlx, data->opt->roof, data->opt->but_night->but_x_min + 4, data->opt->but_night->but_y_min + 15);
	mlx_image_to_window(data->mlx, data->opt->mini, data->opt->but_map->but_x_min + 4, data->opt->but_map->but_y_min + 15);

	mlx_image_to_window(data->mlx, data->opt->m_unvalid, data->opt->but_music->but_x_max - 75, data->opt->but_music->but_y_max - 100);
	mlx_image_to_window(data->mlx, data->opt->f_unvalid, data->opt->but_map->but_x_max - 75, data->opt->but_map->but_y_max - 100);
	mlx_image_to_window(data->mlx, data->opt->fl_unvalid, data->opt->but_fps->but_x_max - 75, data->opt->but_fps->but_y_max - 100);
	mlx_image_to_window(data->mlx, data->opt->r_unvalid, data->opt->but_night->but_x_max - 75, data->opt->but_night->but_y_max - 100);

	mlx_image_to_window(data->mlx, data->opt->m_valid, data->opt->but_music->but_x_max - 75, data->opt->but_music->but_y_max - 100);
	mlx_image_to_window(data->mlx, data->opt->f_valid, data->opt->but_map->but_x_max - 75, data->opt->but_map->but_y_max - 100);
	mlx_image_to_window(data->mlx, data->opt->fl_valid, data->opt->but_fps->but_x_max - 75, data->opt->but_fps->but_y_max - 100);
	mlx_image_to_window(data->mlx, data->opt->r_valid, data->opt->but_night->but_x_max - 75, data->opt->but_night->but_y_max - 100);
